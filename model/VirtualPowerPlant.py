...
class VirtualPowerPlant(object):
    ...
    def balanceAtTimestamp(self, timestamp, mode = "compact"):
        ...
        if mode == "compact":
            ...
            # Return result
            return result
        else: raise ValueError("Current Modes available: full = complete list of components, compact = balanced to single value")